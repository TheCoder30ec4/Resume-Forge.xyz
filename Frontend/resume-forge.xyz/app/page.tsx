  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex flex-col justify-center px-6 pt-24 pb-16 max-w-4xl mx-auto w-full">
        ...
        {/* Headline */}
        <h1 className="text-5xl md:text-7xl font-bold leading-none tracking-tighter mb-4">
          résumé,
          <br />
        ...
        <p className="text-sm md:text-base text-muted-foreground max-w-lg mb-12 leading-relaxed">
          One JD in. One ATS-clean PDF out. Backed by your real GitHub commits
          and LinkedIn history — never invented.
        </p>
      ...
      {/* Footer — social links */}
      <footer className="border-t border-border py-4 px-6 flex items-center justify-center gap-6">
        <a
